...
export async function getStakePoolAccount(
  ...
  console.log(stakePoolAddress.toBase58(),"getstakepool");
  
  const account = await connection.getAccountInfo(stakePoolAddress);
console.log(account,"account");

let dd = StakePoolLayout.decode(account?.data)
console.log(dd,"DD");
...
console.log(connection ,stakePoolAddress.toBase58());

  const stakePoolAccount = await getStakePoolAccount(connection, stakePoolAddress);
  console.log(stakePoolAccount,"stakePoolAccount");
